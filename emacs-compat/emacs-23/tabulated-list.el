...
;; bidi-string-mark-left-to-right exists only in emacs 24
(unless (fboundp 'bidi-string-mark-left-to-right)
  (defalias 'bidi-string-mark-left-to-right 'identity))
...
;; Set this to nil, because emacs23 does not define glyphless-char-display.
(defvar tabulated-list-glyphless-char-display nil)
